...
Django merupakan salah satu web framework free open source yang mengikuti pola arsitektur menggunakan bahasa pemrograman python, django berbasis MVT adalah kependekan dari Model, View, dan Template :
model : merupakan definiti dari data base 
views : berisi fungsi-fungsi untuk mengatur memproses
templat : berhubungan dengan tampilan atau unser interface yang berisi file html
Pengertian Web framework adalah sebuah tools yang berguna untuk memudahkan programmer ketika membuat aplikasi berbasis web.
...
pertama tama kita masuk ke dirctori project kita
cd Dekstop/perpus
django-admin startapp perpustakaan  # cara pertama
...
## Deployment
Pada tahap ini, kita akan mendeploymen aplikasi yang telah dibuat ke server. Dengan awalan mengcoding di local lalu mengupload ke github kemudian di clon atau ditarik ke computer server untuk dideploy disana.
